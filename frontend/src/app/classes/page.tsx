  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Classes</h1>
      ...
      {!loading && classes.length === 0 && (
        <div className="text-center py-16 bg-white border border-slate-200 rounded-xl">
          ...
          <p className="text-slate-500 text-sm font-medium">No classes assigned yet</p>
          {role === "admin" && (
            <p className="text-slate-400 text-xs mt-1">Use the form above to create your first class.</p>
          )}
        </div>
      )}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">
                    <span className="font-medium text-slate-700">{c.teacher?.name || "No teacher"}</span>
                ...
                <div className="flex-1">
                  {c.students?.length === 0 ? (
                    <span className="text-xs text-slate-400 italic">No students enrolled</span>
                  ) : (
